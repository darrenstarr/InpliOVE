        ...
        {
            {
                ...
                new BitmapImage(new Uri("ms-appx://InpliOVE.UWP.App/Assets/DeviceIcons/view1/router.png"))
            },
            {
                Model.DeviceClass.Layer2Switch,
                new BitmapImage(new Uri("ms-appx://InpliOVE.UWP.App/Assets/DeviceIcons/view1/l2switch.png"))
            },
            {
                Model.DeviceClass.MultiLayerSwitch,
                new BitmapImage(new Uri("ms-appx://InpliOVE.UWP.App/Assets/DeviceIcons/view1/mls.png"))
            },
            {
                Model.DeviceClass.Workstation,
                new BitmapImage(new Uri("ms-appx://InpliOVE.UWP.App/Assets/DeviceIcons/view1/workstation.png"))
            },
            {
                Guid.Empty,
                new BitmapImage(new Uri("ms-appx://InpliOVE.UWP.App/Assets/DeviceIcons/view2/QuestionMark.png"))
            },
        };
