    ...
    public class ModelIconConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            if(parentId == Guid.Empty)
                return new BitmapImage(new Uri("ms-appx://InpliOVE.UWP.App/Assets/DeviceIcons/view2/Tenant.png"));
            ...
            if (Model.Context.Current.Sites.SingleOrDefault(x => x.Id == parentId) != null)
                return new BitmapImage(new Uri("ms-appx://InpliOVE.UWP.App/Assets/DeviceIcons/view2/Site.png"));

            if (Model.Context.Current.Devices.SingleOrDefault(x => x.Id == parentId) != null)
                return new BitmapImage(new Uri("ms-appx://InpliOVE.UWP.App/Assets/DeviceIcons/view2/QuestionMark.png"));
